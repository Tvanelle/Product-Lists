<footer class="site-footer">
    ...
    <script src="<?= base_url() ?><?= base_url() ?>public/js/jquery-3.3.1.min.js"></script>
    <script src="<?= base_url() ?><?= base_url() ?>public/js/jquery-migrate-3.0.0.js"></script>
    <script src="<?= base_url() ?><?= base_url() ?>public/js/popper.min.js"></script>
