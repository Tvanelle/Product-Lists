...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 10 août 2021 à 17:21
...
(182, '01.png07.png', 2147483647),
(183, '01.png|', 0),
(184, '08.png', 2147483647),
(185, '01.png|', 2147483647);
...
INSERT INTO `pointvente` (`idPtVte`, `adressePtVte`, `nomPtVte`, `telSitePtVte`, `codeBarProd`) VALUES
(172, 'Mvan', '', '', 2147483647),
(173, 'Mvan', '', '', 2147483647),
(174, 'Mvan|', '', '', 2147483647),
(175, 'Mvan|', '', '', 2147483647),
(176, 'Mvan|', '', '', 2147483647),
(177, 'Nkomo|', '', '', 2147483647),
(178, 'Mvane|', '', '', 2147483647),
(179, 'nkomo|', '', '', 2147483647);
...
(147, '04.png|', 2147483647),
(148, '04.png|', 2147483647),
(149, '04.png|', 2147483647),
(150, '04.png|', 2147483647);
...
--
ALTER TABLE `images`
  MODIFY `idImg` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=186;
...
--
ALTER TABLE `pointvente`
  MODIFY `idPtVte` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180;

--
-- AUTO_INCREMENT pour la table `urlmaker`
--
ALTER TABLE `urlmaker`
  MODIFY `idUrl` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `videos`
  MODIFY `idVideo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;
